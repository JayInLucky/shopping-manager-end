package com.example.utils.generate;
...
import static com.example.utils.generate.CodeGenerator.*;
...
public class MapperGenerator {
    ...
    private static void generateMapperXml(String tableName) {
        ...
        StringBuilder builder = StrUtil.builder().append("<?xml version=\"1.0\" encoding=\"UTF-8\"?>\n" +
                ...
                "<mapper namespace=\"com.example.mapper." + entityClassName + "Mapper\">\n\n");
        ...
        // 查询
        builder.append("    <select id=\"selectAll\" resultType=\"com.example.entity." + entityClassName + "\">\n" +
                "        select\n" +
        ...
        builder.append("    <select id=\"selectById\" resultType=\"com.example.entity." + entityClassName + "\">\n" +
                "        select\n" +
                "        <include refid=\"Base_Column_List\" />\n" +
                "        from " + tableName + "\n" +
                "        where id = #{id}\n" +
        ...
        // 新增
        builder.append("    <insert id=\"insert\" parameterType=\"com.example.entity." + entityClassName + "\" useGeneratedKeys=\"true\">\n" +
        ...
        // 修改
        builder.append("    <update id=\"updateById\" parameterType=\"com.example.entity." + entityClassName + "\">\n" +
                "        update " + tableName + "\n" +
                "        <set>\n");
        tableColumns.forEach(tableColumn -> {
            String camelName = StrUtil.toCamelCase(tableColumn.getName());
    ...
    private static void generateMapper(String tableName) {
        ...
        // 生成导包
        builder.append("import com.example.entity.").append(entityClassName).append(";\n");
